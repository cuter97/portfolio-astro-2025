  ...
  en: {
    ...
    about: {
      ...
      intro: {
        ...
        paragraph2: "Outside of coding, I love reading —especially fiction, philosophy, and psychology books— and spending time in nature. I live in a mountainous area with a lake, so I enjoy going to the beach to share mates with friends or heading into the mountains to build small shelters. I'm also passionate about woodworking, video games, and good moments with coffee or mate.",
  ...
  es: {
    ...
    about: {
      ...
      intro: {
        ...
        paragraph2: "Fuera del código, me encanta leer —especialmente libros de ficción, filosofía y psicología— y pasar tiempo en la naturaleza. Vivo en una zona montañosa con lago, por lo que disfruto ir a la playa a tomar mates con amigos o aventurarme a hacer refugios en la montaña. También me apasiona la carpintería, los video juegos y los buenos momentos acompañados de café o mate.",
        title3: "Mi filosofía",
